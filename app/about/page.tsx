          ...
          <div className="prose prose-gray max-w-none">
            <div className="mb-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-gray-900 mb-2">Hi! We're just a small group of cat nerds</h2>
                  <p className="text-gray-600">who couldn't stop asking the same thing:</p>
                </div>
              </div>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                So, as cat lovers and tool builders, we said: <strong>"Let's make something better."</strong>
              </p>
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-6">
                <p className="text-gray-700 leading-relaxed mb-4">
                  We built an AI-powered tool that doesn't just throw out a breed name — it gives you real insights.
                </p>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Advanced AI identifies physical traits and patterns</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Breed Insights</h4>
                      <p className="text-gray-600 text-sm">Detailed explanations of which breeds your cat resembles</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="text-2xl text-sky-300">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Health Notes</h4>
                      <p className="text-gray-600 text-sm">Possible health and behavior insights</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="text-2xl text-pink-300">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Trusted Sources</h4>
                      <p className="text-gray-600 text-sm">Based on real data from TICA and vet-backed studies</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section className="mb-8">
              ...
              <div className="bg-pink-50 shadow p-6 rounded-lg mb-6">
                <p className="text-gray-700 leading-relaxed mb-4">
                  <span className="font-bold text-pink-700">We believe every cat has a story.</span> Even if they're not purebred, their features and genes hold clues. 
                  Our mission is to help you uncover those clues in a way that's simple, fun, and actually useful.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm">Just upload a photo and get instant results</p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm">Discover your cat's unique traits and characteristics</p>
                </div>
                <div className="text-center">
                  <div className="text-3xl mb-2 text-sky-300">
                  ...
                  <p className="text-gray-600 text-sm">Get actionable insights about health and behavior</p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-sky-50 shadow p-6 rounded-lg ">
                <p className="text-gray-700 leading-relaxed mb-4">
                  <span className="font-bold text-sky-700">We care about your privacy</span> — your photo is deleted right after the results are generated. 
                ...
                <div className="flex items-center gap-2 font-bold text-sky-700">
                  ...
                  <span className="font-medium">Zero data storage guarantee</span>
                </div>
              </div>
            </section>

            <section className="mb-8">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">For Every Cat Parent</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
                This is the tool we wish we had years ago. Now, we're sharing it with every curious cat parent out there — maybe that's you.
              </p>
